...
def kysymys(): #funktio näyttää kysymysmerkin klikkaamisen jälkeen allaolevan tekstin.
    messagebox.showinfo('?','Percentage calculations: Enter a percentage in the Number 1 field'
                        ' and integer to the number 2 field. After that click % button.')
...
ohjelmannimi = Label(ikkuna, text='Calculator', background = 'LightSteelBlue3')
